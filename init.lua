...
require('lazy').setup({
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    opts = {
      ...
      spec = {
        ...
        { 'gr', group = 'LSP', mode = { 'n' } },
        { 'grn', desc = 'Re[N]ame', mode = { 'n' } },
        { 'gri', desc = '[I]mplementation', mode = { 'n' } },
        { 'gra', desc = 'Code [A]ction', mode = { 'n' } },
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sa', ':lua require("telescope").extensions.live_grep_args.live_grep_args()<CR>', { desc = '[S]earch Live Grep [A]rgs' })
